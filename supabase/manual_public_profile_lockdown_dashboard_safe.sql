-- Dashboard-safe manual version of 202605060001_public_profile_lockdown.sql.
-- Run this whole file in Supabase SQL Editor if the migration paste is being
-- truncated. It intentionally avoids dollar-quoted function bodies.

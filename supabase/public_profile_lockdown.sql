-- Dashboard-safe public profile lockdown.
-- Run this file in the Supabase SQL Editor. It avoids dollar-quoted function
-- bodies and only references tables that exist in the current app schema.

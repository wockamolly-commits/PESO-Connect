...
export const computeCourseStrandAlignment = (
...
export const matchRequirementToSkillSet = (requirement, skills = [], aliases = {}, requirementAliases: string[] = []) => {
...
export const calculateDeterministicScore = (job, userData) => {
  ...
  const courseStrandEvidence: any[] = []

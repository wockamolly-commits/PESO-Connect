...
- The education level name in medium weight text
- A brief one-line description below in smaller gray text

Do NOT use emoji. Keep the design clean and text-only.

Card content:
- Elementary (Grades 1-6): description "Primary education"
- High School (Old Curriculum): description "Pre-K12 secondary (4-year)"
- Junior High School (Grades 7-10): description "K-12 lower secondary"
- Senior High School (Grades 11-12): description "K-12 upper secondary with tracks"
- Tertiary: description "College / University degree"
- Graduate Studies / Post-graduate: description "Master's or Doctoral program"

...
const TITLE_SKILL_MAP = {
    ...
    it: [
        { pattern: /web\s*dev|front.?end|back.?end|full.?stack/i, skills: ['Web Development', 'HTML/CSS', 'JavaScript', 'Git Version Control', 'API Development', 'Database Management'] },
        { pattern: /\bjavascript\b|\bjs\s*dev/i, skills: ['JavaScript', 'HTML/CSS', 'Web Development', 'API Development'] },
        ...
        { pattern: /\bjava\b(?!script)/i, skills: ['Java', 'SQL', 'API Development'] },
    ...
    trades: [
        ...
        { pattern: /electri(?:cian|cal\s*(?:worker|tech(?:nician)?))/i, skills: ['Electrical Work', 'Electrical Wiring'] },
...
const DESCRIPTION_SKILL_PATTERNS = [
    ...
    { pattern: /\bweb\s*dev\b|\bwebsite\s*dev\b|\bweb\s*app(?:lication)?s?\b|\bfrontend\b|\bfront.?end\b/i, skill: 'Web Development' },
    { pattern: /\breact(?:\.js)?\b/i, skill: 'React' },
    { pattern: /\bbackend\s*apis?\b|\brest(?:ful)?\s*api\b|\bdevelop.*\bapis?\b|\bapis?\s*and\s*database\b/i, skill: 'API Development' },
    { pattern: /\bdatabase\s*(?:schemas?|design|management|modeling)\b|\bdb\s*schema\b/i, skill: 'Database Management' },
    { pattern: /\bci\/cd\b|\bagile\b|\bscrum\b|\bsprint\b/i, skill: 'Agile/Scrum' },
    { pattern: /\bguest\s*relations\b/i, skill: 'Guest Relations' },
    { pattern: /\bstaff\s*scheduling\b/i, skill: 'Staff Scheduling' },
    { pattern: /\brestaurant\s*(?:management|operations)\b/i, skill: 'Restaurant Management' },
    { pattern: /\bblueprint/i, skill: 'Blueprint Reading' },
    { pattern: /\boccupational\s*safety\b|\bsafety\s*(?:officer|procedures?|compliance)\b/i, skill: 'Safety Officer' },
